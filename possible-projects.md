...
## VK-бот «Мероприятия в Самаре»

Относительно несложный, социально полезный проект, который решает задачу «куда пойти в Самаре» лучше, чем существующие на данный момент решения.

**Сбор и агрегация данных:**
- парсинг мероприятий Самары из разных источников: группы и паблики ВК, Telegram-чаты, различные городские сайты;
- возможность для любого пользователя добавить мероприятие вручную;
- агрегация всех собранных данных в единой базе.

**Функционал для пользователя:**
- подборки мероприятий в рассылке и удобное управление своей подпиской;
- общение с ботом через интуитивное меню кнопок;
- получение мероприятий по фильтрам: на определённую дату, по конкретной тематике и другим параметрам.

**Социальная интеграция (VK):**
- возможность посмотреть, кто из ВК идёт на мероприятие, и отфильтровать этих людей по полу, возрасту и другим параметрам;
- приоритетный показ друзей пользователя, которые тоже отметились как идущие.

**Администрирование и перспективы:**
- панель/функции модерации мероприятий пользователями с правами модератора;
- на перспективу: покупка билетов на платные мероприятия прямо через бота.

**Рынок и референсы:**
- референс: успешное коммерческое решение https://kaverafisha.ru/;
- в Самаре подобных решений пока нет, ниша относительно свободна.

(Заказчик: https://vk.com/artem.smo_i_seo)

## Веб-приложение для подростков «Навыки жизни»

Интерактивный тренажёр для подростков 12–17 лет, который помогает развивать то, чему редко учат в школе: конструктивно общаться, принимать решения, справляться с эмоциями, защищать свои границы, работать в команде, выступать, ставить цели и постепенно становиться самостоятельнее.

Основной принцип: **«Попробуй. Сделай выбор. Посмотри, что получится. Найди свой способ»**.
Подросток получает реальные жизненные ситуации, принимает решения и тренирует навык через короткие интерактивные сценарии.

Главная продуктовая идея:
- вместо уроков — **миссии**;
- вместо контрольных — **жизненные ситуации**;
- вместо отметок — **прогресс навыков**;
- вместо «ты сделал неправильно» — **«посмотрим, к чему может привести такой выбор»**.

Приложение может использоваться самостоятельно, во время подростковых программ, как сопровождение тренингов для подростков и в семейных программах.

Главная цель — помочь подростку становиться самостоятельнее через развитие soft skills: коммуникация, эмоциональный интеллект, уверенность, ответственность, способность делать выбор, критическое мышление, командность, управление конфликтом, саморегуляция, целеполагание, самоорганизация, публичные выступления.

## Веб-приложение «Опора семьи»

Цифровой семейный навигатор, который помогает взрослому понять, что происходит в отношениях с ребёнком, выбрать одну актуальную задачу и шаг за шагом изменить ситуацию через небольшие практические действия.

Человек приходит в приложение не «учиться воспитанию», а с живым запросом: «мы постоянно спорим», «ребёнок меня не слышит», «не понимаю, когда контролировать, а когда отпускать», «я слишком тревожусь», «хочу больше доверия», «мы почти перестали разговаривать».
Приложение отвечает: **«Давайте разберёмся, что происходит, и найдём следующий шаг»**.

Ключевая идея: **не читать о семье, а менять отношения внутри собственной семьи через микропрактики**.

Целевая аудитория: родители детей школьного возраста и подростков; родители, которым важно сохранить контакт с ребёнком; семьи, проходящие программы клуба «Опора и наследие».

Цель — создать простой цифровой инструмент, который помогает родителям:
- лучше понимать ребёнка и замечать собственные реакции;
- снижать количество ненужных конфликтов;
- развивать доверие, договариваться и формировать здоровые семейные правила;
- видеть изменения в отношениях;
- переносить знания из обучения в повседневную жизнь.

## Платформа для уведомлений через соцсети / мессенджеры

Нужно создать платформу (проще всего с web-интерфейсом), для рассылки уведомлений пользователям по их номерам телефонов через соцсети и мессенджеры.

Для каждой рассылки:
- В платформу загружается список номеров телефонов (десятки, сотни)
- По номеру телефона определяется наличие тех или иных соцсетей у человека (VK, Telegram, MAX)
- Производится отправка рассылки (во все найденные мессенджеры человека или в первый найденный мессенджер согласно выставленных приоритетов)
- Все найденные связи номер-телефона → мессенджер/соцсеть сохраняются для последующего переиспользования
- После окончания рассылки по позможности проводится сбор статистики (сколько сообщений и кому дошло / прочитано)

(Заказчик: @Kotlyarova_Evgeniya Евгения, @xtrueman Валерий)

(Любые технические консультации и техническую помощь готов оказать)

## Интернет-магазин с социальной витриной для школы активной жизни «Интегра»

Силами волонтёров создана школа активной жизни «Интегра» для детей и взрослых 18+ с особенностями развития. Ребята своими руками делают пряники, свечи, чаи, текстиль — нужен сайт для продажи этой продукции. Возможно, также понадобится чат-бот для записи на занятия.

По сути это интернет-магазин с социальной витриной: товары показываются как возможности ребят. Покупатель приходит за уникальным ручным изделием, а вместе с ним получает и историю того, кто и как его сделал.
Главная задача сайта — вызывать доверие и гордость, а не жалость.

Пожелания к дизайну — интерфейс, похожий на уютную домашнюю мастерскую:
- тёплые природные оттенки: терракотовый, горчичный, травяной зелёный, молочный бежевый;
- крупные, округлые, легко читаемые шрифты;
- на главной — не просто товары, а фото процесса (руки месят тесто, заваривают чай), это важно.

Структура и функционал:
- простая навигация, категории видны сразу: Пряники, Свечи, Чаи, Текстиль;
- карточка товара: помимо цены — обязательное поле «Кто сделал» (имя мастера);
- блок о проекте с акцентом на то, что всё сертифицировано и безопасно (пряники вкусные, свечи не коптят);
- блок «Как это сделано» — фотоотчёты с мастер-классов;
- блок «Отзывы» — фото счастливых покупателей с пряниками или зажжёнными свечами;
- чат-бот для записи на занятия (опционально).

(Заказчик: https://vk.ru/katerinalev1 Екатерина)

## Приложение для подбора упражнений по йоге-пилатесу

Две идеи на выбор. Реализовать можно в любом виде и с любым типом интерфейса: мобильное приложение / tg-бот / web-платформа.

### Идея 1: ИИ-тренировки с виртуальным тренером (для учеников)

ИИ составляет программу тренировки по запросу ученика — например, «тренировка на ягодичные мышцы, 15 минут». Данные об упражнениях закачиваются из интернета (как источник информации можно использовать, например, YouTube).
Главная фишка — искусственно сгенерированное видео тренера («как в мультфильмах»), который показывает и объясняет, как выполняются упражнения.

Референсы: приложения типа «Тренировки дома», например вот это из AppGallery: https://appgallery.cloud.huawei.com/ag/n/app/C101576701?locale=ru_RU

### Идея 2: ИИ-составитель программ по системе «Полистар» (для тренера)

ИИ-программа, которая составляет программу тренировок под конкретного клиента в системе пилатеса «Полистар» (нужно будет загрузить правила составления программ, названия упражнений и на что они направлены). Видео и картинок не будет, только текст: программы записываются названиями упражнений. Всего 6 уровней сложности программ.

(Заказчик: @LyudmilaSig Людмила)
...
На данный момент это реализовывалось через яндекс-форму и внесение в эксель на компе данных во время тренинга, демонстрация по каждому такту студентам рейтинга (только командного).
