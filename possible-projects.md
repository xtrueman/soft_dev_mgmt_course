...
Если выберете проект из данного списка — свяжитесь с заказчиком и обсудите с ним детали.
Только после связи с заказчиком и наличием договорённости с ним, что он и вы "в деле" — можете считать, что вы проект «взяли» для реализации.
