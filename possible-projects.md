...
Навигационное приложение с векторными картами из OpenStreetMaps,
умеющее роутинг по воде (очень полезно, например, для каякеров для быстрого планирования маршрутов по сложным водным лабиринтам).
...
Также включает web-морду, которая позволяет генерировать отчёты, вроде "Получить средний балл оценок для каждого тудента" и т.п.
...
## Мобильное приложение интернет-магазина (уже взято в работу)
