...
Список проектов на выбор для команд, проходящих курс "Менеджмент разработки ПО" или "Управление IT-проектами".
...
- поиск всех людей / блогов по модели велосипеда их владельцев
- поиск по велосипедным брендам пользователей или по дисциплинам и интересам.
...
# Лендинг, рекламирующий авторский йога-тур в Индию

Референс:
https://laxmitravel.ru/astro-puteshestvie-v-radzhastan/

(Заказчик: @LyudmilaSig)


# Сайт по Human Design

Сайт по методике Human Design и предлагаемым услугам конкретного аналитика Human Design.

Вот что говорит ChatGPT на эту тему:
> Human Design — это синтетическая система самопознания, которая сочетает в себе принципы западной астрологии,
> И-Цзин (Книга Перемен), систему чакр, каббалу, а также современные научные знания, включая генетику и физику.
> Созданная Ра Уру Ху (Робертом Алланом Крачхоуэром) в 1987 году, Human Design предлагает инструменты для
> понимания личных особенностей, талантов, поведения и взаимодействия с окружающим миром.
>
> Консультант по Human Design обычно называется аналитиком Human Design или консультантом Human Design.
> Эти специалисты предлагают индивидуальные консультации и сессии, в ходе которых они анализируют
> Human Design карту человека — уникальную диаграмму, которая, согласно этой системе, отражает
> определенные аспекты его личности, поведения и потенциала. Консультации по Human Design могут
> касаться тем самореализации, принятия решений, отношений и карьеры, и как эти аспекты взаимосвязаны
> с индивидуальным дизайном человека.

Вот что говорит заказчик:
> На сайте следующая информация:
>  1. информация обо мне - факты, фото
>  2. о моем проекте (дизайн человека)
>  3. Виды моих консультаций с описанием и ценой (3-4 разных тарифа)
>  4. Отзывы 

> Нужно, чтобы:
> - была ссылка на связь со мной, переводящая в телеграмм в личный диалог
> - Ссылки на инстаграм
> - Ссылки на телеграмм канал 
> В дальнейшем и на ютуб (но пока он у нас в разработке, появится в ближайшие пару месяцев)
...
# Web-сайт с афишей мероприятий для танцоров + телеграм-бот

Основной функционал — каталог мероприятий.
У мероприятия есть карточка (описание, даты, мессто, стиль и тд.) + Контакты организатора.

Мероприятия можно посмотреть в таблице или плиткой.

Поиск по городу, стилю, названию, типу мероприятия, цене и т.п.

Окно модератора, где происходит правка данных.

Зарегистрированный юзер, может вносить мероприятия, править.
Зарегистрированный юзер должен пройти верификацию, чтобы вносить события.

Пока есть вот такое: Danceafisha.ru.

Возможно, не обязательно брать весь сайт. Можно части/модули

Дополнительный функционал: Телеграм бот, который обращается к сайту, за поиском эвентов

> У меня есть некоммерческая организация, и я бы мог студентам дать благодарственное письмо, или зачесть волонтерские часы
...
# Сайта небольшой мебельной компании.

Стандартный сайт небольшой мебельной компании.
Плюс несложный калькулятор просчёта цен.
Плюс кнопку поставить — вызов на замер.

Мебель на заказ.
Производство, продажа и монтаж корпусной мебели на заказ.
Кухни, шкафы, шкафы-купе, офисная мебель, детская мебель, прихожие, горки.
Выбор материалов для изготовления фасадов без ограничений : ЛДСП; МДФ в плёнке, в эмали, в шпоне; AGT панели; массив. Материалы для столешниц: ВЛДСП в пластике; акриловый камень.
Комплектация заказа фурнитурой по выбору клиента: Hettich, Blum, FS..

(Заказчик: vk@kolibrimc)


# Сайт гончарной студии

Многостраничный сайт. Можно на Тильде
Без магазина и подключенной CRM, но с возможностью подключения в последствии.

(Заказчик: vk@id278961209)
...
Информация-дубль группы вк (https://vk.com/ft_energy).
Плюс чтобы можно было регистрироваться и получать приглашения на игры по возрасту.
Суть в том, что мне не хватает некоторых опций в вк для пары приколюх. Может, это и там можно воплотить.

> Люди жалуются, что когда ищут футбол для взрослых или для женщин в Самаре, наш клуб не находят.
> Сам вк предлагает на основе группы создать сайт для того, чтобы осуществлялся поиск извне.
...
# Сайт по строительству и продаже домов

Компания занимается строительством домов и изготовлением металлоконструкций.
Нужен продающий сайт где представлены варианты домов (в зависимости от используемых материалов
и конструктива - каркасные и капитальные, одно и двух этажные, барнхаусы, А-фреймы,
с верандами и без, с разными вариантами крыши и внешнего вида) а также беседки, промышленные ангары,
гаражи, вагончики, навесы, заборы. Посетителю сайта должно быть удобно и наглядно всё это посмотреть и разобраться.

Картинки предоставим

(Заказчик: vk@id164387415)
...
Задумка есть, фотонаполнение не проблема, текст составлю.
...
# Мобильное приложение для охранной системы

Мы разработали охранную систему для катеров Водный страж, которая управляется через смс сообщения.
Следующим этапом у нас разработка мобльного приложения, которое будет формировать управляющие смс команды
и отображать статусы оборудования по полученным смс командам.
Возможно кого-то из студентов заинтересует задачей. Если получится удачно, то готовы заплатить за работу.
...
# Телеграмм бот для анализа истории чатов

Нужен телеграмм бот, который анализирует историю чата и новые сообщение на вхождение конкретных слов или сочетаний.

Цели:
1. Анализ спроса на какую-то услугу или товар (например «подскажите где хорошо стригут»)
2. В моменте узнать, что задан такой вопрос и пойти ответить человеку ссылкой на свой бизнес
3. Автоматическая рекомендация ботом в чате в ответ на вопрос пользователя 

Целевые чаты - чаты русских экспатов в различных странах/городах где люди ищут нужные услуги, но пока не достаточно освоились на месте
Вторая ЦА - исполнители, тоже русские экспаты.

Уехал в другую страну и не знаешь как продать свою услугу.
Ответ - продавай русским, кому нужна услуга с «русским качеством» у русскоговорящих мастеров.

(Заказчик: vk@a_nanda)


# Сайт: галлерея-витрина художественных произведений искусства

Мне нужен сайт, где будут размещены мои картины. У меня несколько разноплановых серий. В наличии фотографии, описания. Всё уже разнесено по коллекциям. Желательно, чтоб ьыла возможность приобрести работу прямо с сайта. Могу подробнее объяснить свой запрос или совместно участвовать в проекте.

(Заказчик: vk@dogmaseller)
...
(Заказчик: vk@ksu_mcim, tg: @Ksenia_psy)
