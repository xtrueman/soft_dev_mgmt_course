...
Список проектов на выбор для команд, проходящих курс "Менеджмент разработки ПО 2022".
Все проекты реальные от реальных заказчиков, которые ждут, что вы им поможете )


## Telegram-бот для выставления оценки членам команды и получения итоговой оценки за курс (уже взято в работу)
...
## Агрегатор деловых-мероприятий (уже взято в работу)
...
## "Инновационная" социальная сеть для знакомств с блекджком и AI (уже взято в работу)
