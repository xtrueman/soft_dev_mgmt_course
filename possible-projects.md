...
## Telegram-бот для выставления оценки членам команды и получения итоговой оценки за курс (hot!)
...
## Агрегатор деловых-мероприятий (hot!)
...
## Программа для психологического тестирования (уже начата)
