...
Задача 2: создать предложку в телеграм для публикаций в канал из задачи 1 в виде чат-бота.
Для собеседника это будет выглядеть так:  шаг 1 выбор категории (из списка), шаг 2 выбор типа мероприятия (из списка), шаг 3 выбор даты и времени.
