...
Можно реализовать любую из частей (для учеников или для тренеров) или обе сразу.
Обе части можно реализовать в любом виде и с любым типом интерфейса: мобильное приложение / tg-бот / web-платформа.

### Часть для тренера

Приложение, которое составляет программу тренировок под случай конкретного клиента в системе тренировок пилатеса «Полистар» (нужно будет загрузить правила составления программы, упражнения названия и на что направлены). Видео и картинок не будет, только текст / набор упражнений.
Программы будут писаться названиями упражнений. Всего 6 уровней сложности программ.

### Часть для учеников

Приложение / бот / web-платформа (реализовать можно в любом виде и с любым типом интерфейса), которая создаёт подборку программу фитнес тренировок по запросу ученика. По каждому подобранному упражнению будет показываться текстовое описание и заранее записанное тренеров видео с упражнениями, которые сопровождаются объяснением техники.
