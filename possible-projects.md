...
# Интернет-каталог (или интернет-магазин) фермерской продукции

Фермерская продукция: био-квас (с разными наполнениями) и молочная продукция.
Из инфо площадок у нас пока канал в телеге, хотелось бы расширенную площадку со всем ассортиментом.

(Заказчик: https://vk.com/angelfoxe)
