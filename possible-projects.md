...
## Приложение / бот / web-платформа для подбора упражнений по йоге-пилатесу

Можно реализовать любую из частей (для учеников или для тренеров) или обе сразу.

### Часть для тренера

Приложение / бот / web-платформа (реализовать можно в любом виде и с любым типом интерфейса), которая составляет программу  тренировок в системе тренировок пилатеса «Полистар» (нужно будет загрузить правила составления программы, упражнения названия и на что направлены). Видео и картинок не будет, только текст / набор упражнений.
