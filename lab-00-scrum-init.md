...
Орг-вопросы:
- Распределиться по командам (можно включать людей из других групп, но тогда они должны присутствовать с вами на ваших практиках!)
...
- Написать список команды с их ролями и расписать кто что умеет делать и может делать в рамках проекта (расписать компетенции) (в gdocs)
